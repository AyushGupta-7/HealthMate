...
const PreviousReports = () => {
  ...
  const handleDownload = (report) => {
    try {
      // Create a blob from the file content or create a text file with report data
      let content = '';
      let fileName = '';
      let fileType = '';
      
      if (report.fileUrl) {
        // If we have a file URL, we can try to fetch and download it
        fetch(report.fileUrl)
          ...
          .catch(() => {
            // Fallback: Create a text file with report analysis
